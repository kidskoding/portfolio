...
- If a `AGENTS.md` or `.github/` directory exists, check for any commit conventions defined there
...
The human remains the commit `author`; the co-author line credits Codex.
