...
Every semester, someone asks me why I didn't just do CS — as if the *how* of learning doesn't matter, only the *what*. I've always believed that's the wrong question. The real question is: can we build systems that make quality education accessible to everyone, not just those who can afford a seat in the right classroom?
